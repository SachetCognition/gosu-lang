...
public class HtmlDocletWriter extends HtmlDocWriter
{
     ...
     */
    private void addMethodInfo( gw.gosudoc.com.sun.javadoc.MethodDoc method, Content dl) {
        gw.gosudoc.com.sun.javadoc.ClassDoc[] intfacs = method.containingClass().interfaces();
        gw.gosudoc.com.sun.javadoc.MethodDoc overriddenMethod = method.overriddenMethod();
     ...
     */
    protected void addTagsInfo( gw.gosudoc.com.sun.javadoc.Doc doc, Content htmltree) {
        if (configuration.nocomment) {
            return;
        }
        Content dl = new HtmlTree(HtmlTag.DL);
        if (doc instanceof gw.gosudoc.com.sun.javadoc.MethodDoc ) {
            addMethodInfo((gw.gosudoc.com.sun.javadoc.MethodDoc) doc, dl);
        }
     ...
     */
    protected boolean hasSerializationOverviewTags( gw.gosudoc.com.sun.javadoc.FieldDoc field) {
        Content output = new ContentBuilder();
     ...
     */
    public Content getTargetPackageLink( gw.gosudoc.com.sun.javadoc.PackageDoc pd, String target,
                                         Content label) {
     ...
     * @return a content tree for the link
     */
    protected Content getNavLinkPackage( gw.gosudoc.com.sun.javadoc.PackageDoc pkg) {
    ...
    protected Content getNavLinkTree() {
        ...
        gw.gosudoc.com.sun.javadoc.PackageDoc[] packages = configuration.root.specifiedPackages();
     ...
     */
    public Content getPackageName( gw.gosudoc.com.sun.javadoc.PackageDoc packageDoc) {
     ...
     */
    protected void addPackageDeprecatedAPI( List<gw.gosudoc.com.sun.javadoc.Doc> deprPkgs, String headingKey,
        ...
        if (deprPkgs.size() > 0) {
            ...
            for (int i = 0; i < deprPkgs.size(); i++) {
                gw.gosudoc.com.sun.javadoc.PackageDoc pkg = (gw.gosudoc.com.sun.javadoc.PackageDoc) deprPkgs.get(i);
     ...
     */
    protected DocPath pathString( gw.gosudoc.com.sun.javadoc.ClassDoc cd, DocPath name) {
     ...
     */
    protected DocPath pathString( gw.gosudoc.com.sun.javadoc.PackageDoc pd, DocPath name) {
     ...
     */
    public String getPackageAnchorName( gw.gosudoc.com.sun.javadoc.PackageDoc packageDoc) {
     ...
     */
    public Content getPackageLink( gw.gosudoc.com.sun.javadoc.PackageDoc pkg, String label) {
     ...
     * @return a content tree for the package link.
     */
    public Content getPackageLink( gw.gosudoc.com.sun.javadoc.PackageDoc pkg, Content label) {
        boolean included = pkg != null && pkg.isIncluded();
        if (! included) {
            for ( gw.gosudoc.com.sun.javadoc.PackageDoc p : configuration.packages) {
                if (p.equals(pkg)) {
                    included = true;
                    break;
                }
    ...
    public Content italicsClassName( gw.gosudoc.com.sun.javadoc.ClassDoc cd, boolean qual) {
     ...
     */
    public void addSrcLink( gw.gosudoc.com.sun.javadoc.ProgramElementDoc doc, Content label, Content htmltree) {
        if (doc == null) {
            return;
        }
        gw.gosudoc.com.sun.javadoc.ClassDoc cd = doc.containingClass();
        if (cd == null) {
            //d must be a class doc since in has no containing class.
            cd = (gw.gosudoc.com.sun.javadoc.ClassDoc) doc;
        }
    ...
    public boolean isClassLinkable( gw.gosudoc.com.sun.javadoc.ClassDoc cd) {
        if (cd.isIncluded()) {
     ...
     * @return a content tree for the link
     */
    public Content getQualifiedClassLink(LinkInfoImpl.Kind context, gw.gosudoc.com.sun.javadoc.ClassDoc cd) {
     ...
     */
    public void addPreQualifiedClassLink( LinkInfoImpl.Kind context, gw.gosudoc.com.sun.javadoc.ClassDoc cd, Content contentTree) {
    ...
    public Content getPreQualifiedClassLink( LinkInfoImpl.Kind context,
                                             gw.gosudoc.com.sun.javadoc.ClassDoc cd, boolean isStrong) {
        ContentBuilder classlink = new ContentBuilder();
        gw.gosudoc.com.sun.javadoc.PackageDoc pd = cd.containingPackage();
    ...
    public void addPreQualifiedClassLink( LinkInfoImpl.Kind context,
                                          gw.gosudoc.com.sun.javadoc.ClassDoc cd, boolean isStrong, Content contentTree) {
        gw.gosudoc.com.sun.javadoc.PackageDoc pd = cd.containingPackage();
        if(pd != null && ! configuration.shouldExcludeQualifier(pd.name())) {
     ...
     * @param contentTree the content tree to which the link with be added
     */
    public void addPreQualifiedStrongClassLink( LinkInfoImpl.Kind context, gw.gosudoc.com.sun.javadoc.ClassDoc cd, Content contentTree) {
     ...
     */
    public Content getDocLink( LinkInfoImpl.Kind context, gw.gosudoc.com.sun.javadoc.MemberDoc doc, String label) {
     ...
     * @return the link for the given member.
     */
    public Content getDocLink( LinkInfoImpl.Kind context, gw.gosudoc.com.sun.javadoc.ClassDoc classDoc, gw.gosudoc.com.sun.javadoc.MemberDoc doc,
   ...
   /**
    ...
    public Content getDocLink( LinkInfoImpl.Kind context, gw.gosudoc.com.sun.javadoc.ClassDoc classDoc, gw.gosudoc.com.sun.javadoc.MemberDoc doc,
        ...
        if (! (doc.isIncluded() ||
            ...
            gw.gosudoc.com.sun.javadoc.ExecutableMemberDoc emd = (gw.gosudoc.com.sun.javadoc.ExecutableMemberDoc)doc;
        ...
        } else if (doc instanceof gw.gosudoc.com.sun.javadoc.MemberDoc ) {
            return getLink(new LinkInfoImpl(configuration, context, classDoc)
    ...
    public String getAnchor( gw.gosudoc.com.sun.javadoc.ExecutableMemberDoc emd) {
        return getAnchor(emd, false);
    }

    public String getAnchor( gw.gosudoc.com.sun.javadoc.ExecutableMemberDoc emd, boolean isProperty) {
        if (isProperty) {
            return emd.name();
        }
    ...
    public Content seeTagToContent( gw.gosudoc.com.sun.javadoc.SeeTag see) {
        ...
        gw.gosudoc.com.sun.javadoc.ClassDoc refClass = see.referencedClass();
        String refClassName = see.referencedClassName();
        gw.gosudoc.com.sun.javadoc.MemberDoc refMem = see.referencedMember();
        String refMemName = see.referencedMemberName();

        if (refClass == null) {
            //@see is not referencing an included class
            gw.gosudoc.com.sun.javadoc.PackageDoc refPackage = see.referencedPackage();
            ...
            gw.gosudoc.com.sun.javadoc.ClassDoc containing = refMem.containingClass();
            ...
            if (refMem instanceof gw.gosudoc.com.sun.javadoc.ExecutableMemberDoc ) {
                if (refMemName.indexOf('(') < 0) {
                    refMemName += ((gw.gosudoc.com.sun.javadoc.ExecutableMemberDoc)refMem).signature();
                }
            }
     ...
     */
    public void addInlineComment( gw.gosudoc.com.sun.javadoc.Doc doc, gw.gosudoc.com.sun.javadoc.Tag tag, Content htmltree) {
     ...
     * @param htmltree the content tree to which the comment will be added
     */
    public void addInlineDeprecatedComment( gw.gosudoc.com.sun.javadoc.Doc doc, gw.gosudoc.com.sun.javadoc.Tag tag, Content htmltree) {
     ...
     */
    public void addSummaryComment( gw.gosudoc.com.sun.javadoc.Doc doc, Content htmltree) {
     ...
     * @param htmltree the documentation tree to which the summary will be added
     */
    public void addSummaryComment( gw.gosudoc.com.sun.javadoc.Doc doc, gw.gosudoc.com.sun.javadoc.Tag[] firstSentenceTags, Content htmltree) {
        addCommentTags(doc, firstSentenceTags, false, true, htmltree);
    }

    public void addSummaryDeprecatedComment( gw.gosudoc.com.sun.javadoc.Doc doc, gw.gosudoc.com.sun.javadoc.Tag tag, Content htmltree) {
     ...
     */
    public void addInlineComment( gw.gosudoc.com.sun.javadoc.Doc doc, Content htmltree) {
     ...
     */
    private void addCommentTags( gw.gosudoc.com.sun.javadoc.Doc doc, gw.gosudoc.com.sun.javadoc.Tag[] tags, boolean depr,
     ...
     * @param htmltree the documentation tree to which the comment tags will be added
     */
    private void addCommentTags( gw.gosudoc.com.sun.javadoc.Doc doc, gw.gosudoc.com.sun.javadoc.Tag holderTag, gw.gosudoc.com.sun.javadoc.Tag[] tags, boolean depr,
                                 boolean first, Content htmltree) {
        if(configuration.nocomment){
            return;
        }
     ...
     */
    public Content commentTagsToContent( gw.gosudoc.com.sun.javadoc.Tag holderTag, gw.gosudoc.com.sun.javadoc.Doc doc, gw.gosudoc.com.sun.javadoc.Tag[] tags,
        ...
        for (int i = 0; i < tags.length; i++) {
            gw.gosudoc.com.sun.javadoc.Tag tagelem = tags[i];
            String tagName = tagelem.name();
            if (tagelem instanceof gw.gosudoc.com.sun.javadoc.SeeTag ) {
                result.addContent(seeTagToContent((gw.gosudoc.com.sun.javadoc.SeeTag) tagelem));
     ...
     */
    private String redirectRelativeLinks( gw.gosudoc.com.sun.javadoc.Doc doc, String text) {
        ...
        if (doc instanceof gw.gosudoc.com.sun.javadoc.ClassDoc ) {
            redirectPathFromRoot = DocPath.forPackage(((gw.gosudoc.com.sun.javadoc.ClassDoc) doc).containingPackage());
        } else if (doc instanceof gw.gosudoc.com.sun.javadoc.MemberDoc ) {
            redirectPathFromRoot = DocPath.forPackage(((gw.gosudoc.com.sun.javadoc.MemberDoc) doc).containingPackage());
        } else if (doc instanceof gw.gosudoc.com.sun.javadoc.PackageDoc ) {
            redirectPathFromRoot = DocPath.forPackage((gw.gosudoc.com.sun.javadoc.PackageDoc) doc);
        } else {
            return text;
        }
     ...
     */
    public boolean isCoreClass( gw.gosudoc.com.sun.javadoc.ClassDoc cd) {
     ...
     *        added
     */
    public void addAnnotationInfo( gw.gosudoc.com.sun.javadoc.PackageDoc packageDoc, Content htmltree) {
     ...
     *        added
     */
    public void addReceiverAnnotationInfo( gw.gosudoc.com.sun.javadoc.ExecutableMemberDoc method, gw.gosudoc.com.sun.javadoc.AnnotationDesc[] descList,
                                           Content htmltree) {
     ...
     */
    public void addAnnotationInfo( gw.gosudoc.com.sun.javadoc.ProgramElementDoc doc, Content htmltree) {
     ...
     */
    public boolean addAnnotationInfo( int indent, gw.gosudoc.com.sun.javadoc.Doc doc, gw.gosudoc.com.sun.javadoc.Parameter param,
                                      Content tree) {
     ...
     *
     * @param doc the doc to write annotations for.
     * @param descList the array of {@link gw.gosudoc.com.sun.javadoc.AnnotationDesc}.
     * @param htmltree the documentation tree to which the annotation info will be
     *        added
     */
    private void addAnnotationInfo( gw.gosudoc.com.sun.javadoc.Doc doc, gw.gosudoc.com.sun.javadoc.AnnotationDesc[] descList,
                                    Content htmltree) {
     ...
     *        added
     */
    private boolean addAnnotationInfo( int indent, gw.gosudoc.com.sun.javadoc.Doc doc,
                                       gw.gosudoc.com.sun.javadoc.AnnotationDesc[] descList, boolean lineBreak, Content htmltree) {
   ...
   /**
     ...
     *         documented.
     */
    private List<Content> getAnnotations( int indent, gw.gosudoc.com.sun.javadoc.AnnotationDesc[] descList, boolean linkBreak) {
     ...
     *         documented.
     */
    public List<Content> getAnnotations( int indent, gw.gosudoc.com.sun.javadoc.AnnotationDesc[] descList, boolean linkBreak,
                                         boolean isJava5DeclarationLocation) {
        List<Content> results = new ArrayList<>();
        ContentBuilder annotation;
        for ( gw.gosudoc.com.sun.javadoc.AnnotationDesc aDesc : descList) {
            gw.gosudoc.com.sun.javadoc.AnnotationTypeDoc annotationDoc = aDesc.annotationType();
            ...
            gw.gosudoc.com.sun.javadoc.AnnotationDesc.ElementValuePair[] pairs = aDesc.elementValues();
            // If the annotation is synthesized, do not print the container.
            if (aDesc.isSynthesized()) {
                for ( gw.gosudoc.com.sun.javadoc.AnnotationDesc.ElementValuePair pair : pairs) {
                    gw.gosudoc.com.sun.javadoc.AnnotationValue annotationValue = pair.value();
                    List<gw.gosudoc.com.sun.javadoc.AnnotationValue> annotationTypeValues = new ArrayList<>();
                    if (annotationValue.value() instanceof gw.gosudoc.com.sun.javadoc.AnnotationValue[]) {
                        gw.gosudoc.com.sun.javadoc.AnnotationValue[] annotationArray =
                                (gw.gosudoc.com.sun.javadoc.AnnotationValue[]) annotationValue.value();
                        annotationTypeValues.addAll(Arrays.asList(annotationArray));
                    } else {
                        annotationTypeValues.add(annotationValue);
                    }
                    String sep = "";
                    for ( gw.gosudoc.com.sun.javadoc.AnnotationValue av : annotationTypeValues) {
                ...
                if (pairs.length == 1 && isAnnotationDocumented) {
                    gw.gosudoc.com.sun.javadoc.AnnotationValue[] annotationArray =
                            (gw.gosudoc.com.sun.javadoc.AnnotationValue[]) (pairs[0].value()).value();
                    List<gw.gosudoc.com.sun.javadoc.AnnotationValue> annotationTypeValues = new ArrayList<>();
                    annotationTypeValues.addAll(Arrays.asList(annotationArray));
                    String sep = "";
                    for ( gw.gosudoc.com.sun.javadoc.AnnotationValue av : annotationTypeValues) {
     ...
     * @param linkBreak if true, add new line between each member value
     */
    private void addAnnotations( gw.gosudoc.com.sun.javadoc.AnnotationTypeDoc annotationDoc, LinkInfoImpl linkInfo,
                                 ContentBuilder annotation, gw.gosudoc.com.sun.javadoc.AnnotationDesc.ElementValuePair[] pairs,
        ...
        if (pairs.length > 0) {
            ...
            for (int j = 0; j < pairs.length; j++) {
                ...
                annotation.addContent("=");
                gw.gosudoc.com.sun.javadoc.AnnotationValue annotationValue = pairs[j].value();
                List<gw.gosudoc.com.sun.javadoc.AnnotationValue> annotationTypeValues = new ArrayList<>();
                if (annotationValue.value() instanceof gw.gosudoc.com.sun.javadoc.AnnotationValue[]) {
                    gw.gosudoc.com.sun.javadoc.AnnotationValue[] annotationArray =
                            (gw.gosudoc.com.sun.javadoc.AnnotationValue[]) annotationValue.value();
     ...
     */
    private boolean isAnnotationArray( gw.gosudoc.com.sun.javadoc.AnnotationDesc.ElementValuePair[] pairs) {
        gw.gosudoc.com.sun.javadoc.AnnotationValue annotationValue;
        for ( gw.gosudoc.com.sun.javadoc.AnnotationDesc.ElementValuePair pair : pairs) {
            ...
            if (annotationValue.value() instanceof gw.gosudoc.com.sun.javadoc.AnnotationValue[]) {
                ...
                if (annotationArray.length > 1) {
                    if (annotationArray[0].value() instanceof gw.gosudoc.com.sun.javadoc.AnnotationDesc ) {
                        gw.gosudoc.com.sun.javadoc.AnnotationTypeDoc annotationDoc =
                                ((gw.gosudoc.com.sun.javadoc.AnnotationDesc) annotationArray[0].value()).annotationType();
    ...
    private Content annotationValueToContent( gw.gosudoc.com.sun.javadoc.AnnotationValue annotationValue) {
        if (annotationValue.value() instanceof gw.gosudoc.com.sun.javadoc.Type ) {
            gw.gosudoc.com.sun.javadoc.Type type = (gw.gosudoc.com.sun.javadoc.Type) annotationValue.value();
        ...
        } else if (annotationValue.value() instanceof gw.gosudoc.com.sun.javadoc.AnnotationDesc ) {
            List<Content> list = getAnnotations(0,
                new gw.gosudoc.com.sun.javadoc.AnnotationDesc[]{(gw.gosudoc.com.sun.javadoc.AnnotationDesc) annotationValue.value()},
                    false);
            ...
            return buf;
        } else if (annotationValue.value() instanceof gw.gosudoc.com.sun.javadoc.MemberDoc ) {
            return getDocLink(LinkInfoImpl.Kind.ANNOTATION,
                (gw.gosudoc.com.sun.javadoc.MemberDoc) annotationValue.value(),
                ((gw.gosudoc.com.sun.javadoc.MemberDoc) annotationValue.value()).name(), false);
         } else {
